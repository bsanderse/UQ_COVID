...
if (find(strcmp(methods,'PCE_Quad')))
    semilogx(NsamplesQuad, mean_Quad, 's-','Linewidth', 2);%,'Color', myColors(2,:));
    hold on
    legappend('PCE-Quad')
end
if (find(strcmp(methods,'PCE_OLS')))
    semilogx(NsamplesOLS, mean_OLS, 'o-','Linewidth', 2); %,'Color', 'y');
    hold on
    legappend('PCE-OLS')
end
if (find(strcmp(methods,'PCE_LARS')))
    semilogx(NsamplesLARS, mean_LARS, 'd-','Linewidth', 2); %,'Color', 'r');
    hold on
    legappend('PCE-LARS')    
end
...
if (find(strcmp(methods,'PCE_Quad')))
    semilogx(NsamplesQuad, std_Quad, 's-','Linewidth', 2);%,'Color', myColors(2,:));
    hold on
    legappend('PCE-Quad')
    
end
if (find(strcmp(methods,'PCE_OLS')))
    semilogx(NsamplesOLS, std_OLS, 'o-','Linewidth', 2); %,'Color', 'y');
    hold on
    legappend('PCE-OLS')
    
end
if (find(strcmp(methods,'PCE_LARS')))
    semilogx(NsamplesLARS, std_LARS, 'd-','Linewidth', 2); %,'Color', 'r');
    hold on
    legappend('PCE-LARS')    
